...
def parse_args():
    parser = argparse.ArgumentParser(description="Speed and FLOPs test for DeepSeek-7B-Chat generation")
    ...
    parser.add_argument("--model_path", type=str, default="deepseek-ai/deepseek-coder-7b-instruct-v1.5", help="Path to DeepSeek model")
...
def create_prompt(tokenizer, length):
    ...
    sentence = "This is a test sentence used to simulate a long prompt for the DeepSeek model. "
